...
extern void dart_board_draw_sectors(cv::Mat& image, int ThreadId, int image_show = 1, int cal = 1, int show_num = 1);
extern void dart_board_color_sectors(cv::Mat& dst);
