...
extern void drawLine(cv::Mat& img, cv::Point p, cv::Vec2f dir, cv::Scalar color, int length = 1000);
extern void calculatePolarCoordinates(cv::Point p, cv::Vec2f dir, cv::Mat& img, float& r, float& theta);
